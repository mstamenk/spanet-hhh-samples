...
R2_bbH = Coupling(name = 'R2_bbH',
                value = '(-((complex(0,1)*yb)*ctheta/cmath.sqrt(2)))*(2.0*R2MixedFactor)',
                order = {'QCD':2,'QED':1})

R2_bbeta0 = Coupling(name = 'R2_bbeta0',
                value = '(-((complex(0,1)*yb)*stheta/cmath.sqrt(2)))*(2.0*R2MixedFactor)',
                order = {'QCD':2,'QED':1})

R2_ttH = Coupling(name = 'R2_ttH',
                value = '(-((complex(0,1)*yt)*ctheta/cmath.sqrt(2)))*(2.0*R2MixedFactor)',
                order = {'QCD':2,'QED':1})

R2_tteta0 = Coupling(name = 'R2_tteta0',
                value = '(-((complex(0,1)*yt)*stheta/cmath.sqrt(2)))*(2.0*R2MixedFactor)',
                order = {'QCD':2,'QED':1})

R2_ccH = Coupling(name = 'R2_ccH',
                value = '(-((complex(0,1)*yc)*ctheta/cmath.sqrt (2)))*(2.0*R2MixedFactor)',
                order = {'QCD':2,'QED':1})

R2_cceta0 = Coupling(name = 'R2_cceta0',
                value = '(-((complex(0,1)*yc)*stheta/cmath.sqrt (2)))*(2.0*R2MixedFactor)',
                order = {'QCD':2,'QED':1})
...
R2_GGHc = Coupling(name = 'R2_GGHc',
                value = '4.0*(-((complex(0,1)*yc)*ctheta/cmath.sqrt(2)))*(1.0/2.0)*(G**2/(8.0*cmath.pi**2))*MC',
                order = {'QCD':2,'QED':1})

R2_GGHb = Coupling(name = 'R2_GGHb',
                value = '4.0*(-((complex(0,1)*yb)*ctheta/cmath.sqrt(2)))*(1.0/2.0)*(G**2/(8.0*cmath.pi**2))*MB',
                order = {'QCD':2,'QED':1})

R2_GGHt = Coupling(name = 'R2_GGHt',
                value = '4.0*(-((complex(0,1)*yt)*ctheta/cmath.sqrt(2)))*(1.0/2.0)*(G**2/(8.0*cmath.pi**2))*MT',
                order = {'QCD':2,'QED':1})

R2_GGeta0c = Coupling(name = 'R2_GGeta0c',
                value = '4.0*(-((complex(0,1)*yc)*stheta/cmath.sqrt(2)))*(1.0/2.0)*(G**2/(8.0*cmath.pi**2))*MC',
                order = {'QCD':2,'QED':1})

R2_GGeta0b = Coupling(name = 'R2_GGeta0b',
                value = '4.0*(-((complex(0,1)*yb)*stheta/cmath.sqrt(2)))*(1.0/2.0)*(G**2/(8.0*cmath.pi**2))*MB',
                order = {'QCD':2,'QED':1})

R2_GGeta0t = Coupling(name = 'R2_GGHeta0',
                value = '4.0*(-((complex(0,1)*yt)*stheta/cmath.sqrt(2)))*(1.0/2.0)*(G**2/(8.0*cmath.pi**2))*MT',
                order = {'QCD':2,'QED':1})
...
R2_GGHHc = Coupling(name = 'R2_GGHHc',
                    value = {0:'4.0*(-yc**2/2.0)*(1.0/2.0)*ctheta**2*((complex(0,1)*G**2)/(8.0*cmath.pi**2))'},
                    order = {'QCD':2,'QED':2})

R2_GGHHb = Coupling(name = 'R2_GGHHb',
                    value = {0:'4.0*(-yb**2/2.0)*(1.0/2.0)*ctheta**2*((complex(0,1)*G**2)/(8.0*cmath.pi**2))'},
                    order = {'QCD':2,'QED':2})

R2_GGHHt = Coupling(name = 'R2_GGHHt',
                    value = {0:'4.0*(-yt**2/2.0)*(1.0/2.0)*ctheta**2*((complex(0,1)*G**2)/(8.0*cmath.pi**2))'},
                    order = {'QCD':2,'QED':2})

R2_GGeta0eta0c = Coupling(name = 'R2_GGeta0eta0c',
                    value = {0:'4.0*(-yc**2/2.0)*(1.0/2.0)*stheta**2*((complex(0,1)*G**2)/(8.0*cmath.pi**2))'},
                    order = {'QCD':2,'QED':2})

R2_GGeta0eta0b = Coupling(name = 'R2_GGeta0eta0b',
                    value = {0:'4.0*(-yb**2/2.0)*(1.0/2.0)*stheta**2*((complex(0,1)*G**2)/(8.0*cmath.pi**2))'},
                    order = {'QCD':2,'QED':2})

R2_GGeta0eta0t = Coupling(name = 'R2_GGeta0eta0t',
                    value = {0:'4.0*(-yt**2/2.0)*(1.0/2.0)*stheta**2*((complex(0,1)*G**2)/(8.0*cmath.pi**2))'},
                    order = {'QCD':2,'QED':2})

R2_GGHeta0c = Coupling(name = 'R2_GGHeta0c',
                    value = {0:'4.0*(-yc**2/2.0)*(1.0/2.0)*stheta*ctheta*((complex(0,1)*G**2)/(8.0*cmath.pi**2))'},
                    order = {'QCD':2,'QED':2})

R2_GGHeta0b = Coupling(name = 'R2_GGHeta0b',
                    value = {0:'4.0*(-yb**2/2.0)*(1.0/2.0)*stheta*ctheta*((complex(0,1)*G**2)/(8.0*cmath.pi**2))'},
                    order = {'QCD':2,'QED':2})

R2_GGHeta0t = Coupling(name = 'R2_GGHeta0t',
                    value = {0:'4.0*(-yt**2/2.0)*(1.0/2.0)*stheta*ctheta*((complex(0,1)*G**2)/(8.0*cmath.pi**2))'},
                    order = {'QCD':2,'QED':2})
...
UV_Hcc = Coupling(name = 'UV_Hcc',
                 value = '-((complex(0,1)*yc)*ctheta/cmath.sqrt(2))*UV_yuk_c',
                 order = {'QED':1,'QCD':2})

UV_Htt = Coupling(name = 'UV_Htt',
                 value = '-((complex(0,1)*yt)*ctheta/cmath.sqrt(2))*UV_yuk_t',
                 order = {'QED':1,'QCD':2})

UV_Hbb = Coupling(name = 'UV_Hbb',
                 value = '-((complex(0,1)*yb)*ctheta/cmath.sqrt(2))*UV_yuk_b',
                 order = {'QED':1,'QCD':2})

UV_eta0cc = Coupling(name = 'UV_eta0cc',
                 value = '-((complex(0,1)*yc)*stheta/cmath.sqrt(2))*UV_yuk_c',
                 order = {'QED':1,'QCD':2})

UV_eta0tt = Coupling(name = 'UV_eta0tt',
                 value = '-((complex(0,1)*yt)*stheta/cmath.sqrt(2))*UV_yuk_t',
                 order = {'QED':1,'QCD':2})

UV_eta0bb = Coupling(name = 'UV_eta0bb',
                 value = '-((complex(0,1)*yb)*stheta/cmath.sqrt(2))*UV_yuk_b',
                 order = {'QED':1,'QCD':2})
