...
GC_30 = Coupling(name = 'GC_30',                 value = '-6*complex(0,1)*kap111',
                 order = {'QED':1})
...
GC_10 = Coupling(name = 'GC_10',
                 value = '(ee**2*complex(0,1))*ctheta**2/(2.*sw**2)',
                 order = {'QED':2})
...
GC_29 = Coupling(name = 'GC_29',
                 value = '(ee**2*complex(0,1) + (cw**2*ee**2*complex(0,1))/(2.*sw**2) + (ee**2*complex(0,1)*sw**2)/(2.*cw**2))*ctheta**2',
                 order = {'QED':2})

GC_929 = Coupling(name = 'GC_929',
                 value = '(ee**2*complex(0,1) + (cw**2*ee**2*complex(0,1))/(2.*sw**2) + (ee**2*complex(0,1)*sw**2)/(2.*cw**2))*stheta**2',
                 order = {'QED':2})

GC_31 = Coupling(name = 'GC_31',
                 value = '(ee**2*complex(0,1)*v)*ctheta/(2.*sw**2)',
                 order = {'QED':1})

GC_931 = Coupling(name = 'GC_931',
                 value = '(ee**2*complex(0,1)*v)*stheta/(2.*sw**2)',
                 order = {'QED':1})

GC_32 = Coupling(name = 'GC_32',
                 value = '(ee**2*complex(0,1)*v + (cw**2*ee**2*complex(0,1)*v)/(2.*sw**2) + (ee**2*complex(0,1)*sw**2*v)/(2.*cw**2))*ctheta',
                 order = {'QED':1})

GC_932 = Coupling(name = 'GC_932',
                 value = '(ee**2*complex(0,1)*v + (cw**2*ee**2*complex(0,1)*v)/(2.*sw**2) + (ee**2*complex(0,1)*sw**2*v)/(2.*cw**2))*stheta',
                 order = {'QED':1})


GC_33 = Coupling(name = 'GC_33',
                 value = '-((complex(0,1)*yb)*ctheta/cmath.sqrt(2))',
                 order = {'QED':1})

GC_933 = Coupling(name = 'GC_933',
                 value = '-((complex(0,1)*yb)*stheta/cmath.sqrt(2))',
                 order = {'QED':1})


GC_34 = Coupling(name = 'GC_34',
                 value = '-((complex(0,1)*yc)*ctheta/cmath.sqrt(2))',
                 order = {'QED':1})

GC_934 = Coupling(name = 'GC_934',
                 value = '-((complex(0,1)*yc)*stheta/cmath.sqrt(2))',
                 order = {'QED':1})

GC_35 = Coupling(name = 'GC_35',
                 value = '-((complex(0,1)*ye)*ctheta/cmath.sqrt(2))',
                 order = {'QED':1})

GC_935 = Coupling(name = 'GC_935',
                 value = '-((complex(0,1)*ye)*stheta/cmath.sqrt(2))',
                 order = {'QED':1})


GC_36 = Coupling(name = 'GC_36',
                 value = '-((complex(0,1)*ym)*ctheta/cmath.sqrt(2))',
                 order = {'QED':1})

GC_936 = Coupling(name = 'GC_936',
                 value = '-((complex(0,1)*ym)*stheta/cmath.sqrt(2))',
                 order = {'QED':1})

GC_37 = Coupling(name = 'GC_37',
                 value = '-((complex(0,1)*yt)*ctheta/cmath.sqrt(2))',
                 order = {'QED':1})

GC_937 = Coupling(name = 'GC_937',
                 value = '-((complex(0,1)*yt)*stheta/cmath.sqrt(2))',
                 order = {'QED':1})


GC_38 = Coupling(name = 'GC_38',
                 value = '-((complex(0,1)*ytau)*ctheta/cmath.sqrt(2))',
                 order = {'QED':1})

GC_938 = Coupling(name = 'GC_938',
                 value = '-((complex(0,1)*ytau)*stheta/cmath.sqrt(2))',
                 order = {'QED':1})
