...
V_bbeta0 = CTVertex(name = 'V_bbeta0',
              particles = [ P.b__tilde__, P.b, P.eta0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.b,P.G]]],
              couplings = {(0,0,0):C.R2_bbeta0},
              type = 'R2')

V_bbiota0 = CTVertex(name = 'V_bbiota0',
              particles = [ P.b__tilde__, P.b, P.iota0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.b,P.G]]],
              couplings = {(0,0,0):C.R2_bbiota0},
              type = 'R2')
...
V_tteta0 = CTVertex(name = 'V_tteta0',
              particles = [ P.t__tilde__, P.t, P.eta0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.t,P.G]]],
              couplings = {(0,0,0):C.R2_tteta0},
              type = 'R2')

V_ttiota0 = CTVertex(name = 'V_ttiota0',
              particles = [ P.t__tilde__, P.t, P.iota0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.t,P.G]]],
              couplings = {(0,0,0):C.R2_ttiota0},
              type = 'R2')
...
V_cceta0 = CTVertex(name = 'V_cceta0',
              particles = [ P.c__tilde__, P.c, P.eta0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.c,P.G]]],
              couplings = {(0,0,0):C.R2_cceta0},
              type = 'R2')

V_cciota0 = CTVertex(name = 'V_cciota0',
              particles = [ P.c__tilde__, P.c, P.iota0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.c,P.G]]],
              couplings = {(0,0,0):C.R2_cciota0},
              type = 'R2')
...
V_GGHeta0 = CTVertex(name = 'V_GGHeta0',
              particles = [ P.G, P.G, P.H, P.eta0 ],
              color = [ 'Tr(1,2)' ],
              lorentz = [ L.R2_GGHH ],
              loop_particles = [[[P.c]],[[P.b]],[[P.t]]],
              couplings = {(0,0,0):C.R2_GGHeta0c,(0,0,1):C.R2_GGHeta0b,(0,0,2):C.R2_GGHeta0t},
              type = 'R2')

V_GGHiota0 = CTVertex(name = 'V_GGHiota0',
              particles = [ P.G, P.G, P.H, P.iota0 ],
              color = [ 'Tr(1,2)' ],
              lorentz = [ L.R2_GGHH ],
              loop_particles = [[[P.c]],[[P.b]],[[P.t]]],
              couplings = {(0,0,0):C.R2_GGHiota0c,(0,0,1):C.R2_GGHiota0b,(0,0,2):C.R2_GGHiota0t},
              type = 'R2')

V_GGiota0eta0 = CTVertex(name = 'V_GGiota0eta0',
              particles = [ P.G, P.G, P.iota0, P.eta0 ],
              color = [ 'Tr(1,2)' ],
              lorentz = [ L.R2_GGHH ],
              loop_particles = [[[P.c]],[[P.b]],[[P.t]]],
              couplings = {(0,0,0):C.R2_GGiota0eta0c,(0,0,1):C.R2_GGiota0eta0b,(0,0,2):C.R2_GGiota0eta0t},
              type = 'R2')

V_GGeta0 = CTVertex(name = 'V_GGeta0',
              particles = [ P.G, P.G, P.eta0 ],
              color = [ 'Tr(1,2)' ],
              lorentz = [ L.VVS1 ],
              loop_particles = [[[P.c]],[[P.b]],[[P.t]]],
              couplings = {(0,0,0):C.R2_GGeta0c,(0,0,1):C.R2_GGeta0b,(0,0,2):C.R2_GGeta0t},
              type = 'R2')

V_GGeta0eta0 = CTVertex(name = 'V_GGeta0eta0',
              particles = [ P.G, P.G, P.eta0, P.eta0 ],
              color = [ 'Tr(1,2)' ],
              lorentz = [ L.R2_GGHH ],
              loop_particles = [[[P.c]],[[P.b]],[[P.t]]],
              couplings = {(0,0,0):C.R2_GGeta0eta0c,(0,0,1):C.R2_GGeta0eta0b,(0,0,2):C.R2_GGeta0eta0t},
              type = 'R2')

V_GGiota0 = CTVertex(name = 'V_GGiota0',
              particles = [ P.G, P.G, P.iota0 ],
              color = [ 'Tr(1,2)' ],
              lorentz = [ L.VVS1 ],
              loop_particles = [[[P.c]],[[P.b]],[[P.t]]],
              couplings = {(0,0,0):C.R2_GGiota0c,(0,0,1):C.R2_GGiota0b,(0,0,2):C.R2_GGiota0t},
              type = 'R2')

V_GGiota0iota0 = CTVertex(name = 'V_GGiota0iota0',
              particles = [ P.G, P.G, P.iota0, P.iota0 ],
              color = [ 'Tr(1,2)' ],
              lorentz = [ L.R2_GGHH ],
              loop_particles = [[[P.c]],[[P.b]],[[P.t]]],
              couplings = {(0,0,0):C.R2_GGiota0iota0c,(0,0,1):C.R2_GGiota0iota0b,(0,0,2):C.R2_GGiota0iota0t},
              type = 'R2')
...
V_UVeta0cc = CTVertex(name = 'V_UVeta0cc',
              particles = [ P.c__tilde__, P.c, P.eta0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.G,P.c]]],                   
              couplings = {(0,0,0):C.UV_eta0cc},
              type = 'UV')

V_UVeta0tt = CTVertex(name = 'V_UVeta0tt',
              particles = [ P.t__tilde__, P.t, P.eta0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.G,P.t]]],                   
              couplings = {(0,0,0):C.UV_eta0tt},
              type = 'UV')

V_UVeta0bb = CTVertex(name = 'V_UVeta0bb',
              particles = [ P.b__tilde__, P.b, P.eta0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.G,P.b]]],
              couplings = {(0,0,0):C.UV_eta0bb},
              type = 'UV')

V_UViota0cc = CTVertex(name = 'V_UViota0cc',
              particles = [ P.c__tilde__, P.c, P.iota0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.G,P.c]]],                   
              couplings = {(0,0,0):C.UV_iota0cc},
              type = 'UV')

V_UViota0tt = CTVertex(name = 'V_UViota0tt',
              particles = [ P.t__tilde__, P.t, P.iota0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.G,P.t]]],                   
              couplings = {(0,0,0):C.UV_iota0tt},
              type = 'UV')

V_UViota0bb = CTVertex(name = 'V_UViota0bb',
              particles = [ P.b__tilde__, P.b, P.iota0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              loop_particles = [[[P.G,P.b]]],
              couplings = {(0,0,0):C.UV_iota0bb},
              type = 'UV')
